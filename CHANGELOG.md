...
- agent: Import of ClusterShell NodeSet class (#682). Contribution from
  @faganihajizada.
- front: Update dependencies to fix CVE-2025-13465 (lodash), CVE-2026-25639
  (axios), CVE-2026-27606 (rollup), CVE-2026-27903, CVE-2026-27904,
  CVE-2026-26996 (minimatch), CVE-2026-32141, CVE-2026-33228 (flatted),
  CVE-2026-33671, CVE-2026-33672 (picomatch) and CVE-2026-39363 (vite).
...
- conf:
  ...
  - Update description of `[ui]` > `host` gateway parameter to explain its role
...
[unreleased]: https://github.com/rackslab/Slurm-web/compare/v6.0.0...HEAD
