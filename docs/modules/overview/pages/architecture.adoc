...
key/value database to save cached data from Slurm. It can also
xref:overview.adoc#metrics[export metrics] to https://prometheus.io/[Prometheus]
(or compatible) in order to store values in timeseries databases.
