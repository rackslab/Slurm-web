...
|image:{distribsdir}/sles.png[SLES,xref=install/distribs/sles.adoc]
.^|xref:install/distribs/sles.adoc[SUSE Linux Enterprise Server (SLES)]

|image:{distribsdir}/opensuse.png[opensuse,xref=install/distribs/opensuse.adoc]
.^|xref:install/distribs/opensuse.adoc[openSUSE]
|===
