...
Then run this command, for example with `slurm-web_{version}-1.deb13.dsc`:

[source,console,subs=attributes]
----
$ dget -ux https://pkgs.rackslab.io/deb/{pkgs-derivative}/main/s/slurm-web/slurm-web_{version}-1.deb13.dsc
----
